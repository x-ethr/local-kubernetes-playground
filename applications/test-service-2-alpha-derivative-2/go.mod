module test-service-2-alpha-derivative-2

go 1.22.3

require (
	github.com/x-ethr/server v0.1.28
...
require (
	...
	github.com/x-ethr/color v0.1.2 // indirect
	github.com/x-ethr/text v0.1.18 // indirect
